...
func NewSnippetRepository() SnippetRepository {
	r := SnippetRepository{}
	r.Collection = "snippets"

	return r
}

func (x SnippetRepository) List(projectId string, query interface{}, projection interface{},
...
func (x SnippetRepository) Count(projectId string, query interface{}) (int64, *utils.DataPadError) {
	c := db.GetDB().Collection(x.Collection)
