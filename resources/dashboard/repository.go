...
func NewDashboardRepository() DashboardRepository {
	...
	r.Collection = "dashboards"

	return r
}

func (x DashboardRepository) List(projectId string, query interface{}, projection interface{},
...
func (x DashboardRepository) Count(projectId string, query interface{}) (int64, *utils.DataPadError) {
	c := db.GetDB().Collection(x.Collection)
